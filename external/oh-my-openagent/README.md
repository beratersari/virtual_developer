...
@beratersari
# Build ONE image
docker build -f jira-bot/Dockerfile.combined -t jira-virtual-dev .

# Run
docker compose -f jira-bot/docker-compose.combined.yml up -d

# Check logs
docker compose -f jira-bot/docker-compose.combined.yml logs -f